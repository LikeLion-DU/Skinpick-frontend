...
enum SkinType {
  ...
  ///
  /// **타입의 성향만 말하고 지표 값을 단정하지 않는다.** 이 문장은 지표 막대·타일
  /// 바로 위에 놓이는데, "유분이 부족해" 같은 말은 그 아래 "유분 · 보통 · 59" 와
  /// 어긋날 수 있다 — 타입은 서버가 유분>70/유분>=60/수분<40 세 갈래로만 정하고
  /// 나머지 지표는 각자 등급을 따로 받는다.
  ///
  /// [unknown] 은 null 이다. "잘 모르겠어요"는 피부 타입이 아니라 미선택 표시라
  /// 설명할 대상이 없다.
  String? get description => switch (this) {
        dry => '수분이 쉽게 마르고 당김이 느껴지기 쉬운 피부 타입이에요.',
        ...
        normal => '수분과 유분이 크게 치우치지 않는 편인 피부 타입이에요.',
        unknown => null,
      };
